...
import org.example.base.java8.day02.Employee.Status;
...
public class TestStreamAPI3 {
  ...
  */
  ...
  public void test4() {
    Optional<Double> max =
        emps.stream().map(Employee::getSalary).collect(Collectors.maxBy(Double::compare));
  ...
  public void test9() {
    Optional<Double> sum =
        emps.stream().map(Employee::getSalary).collect(Collectors.reducing(Double::sum));
